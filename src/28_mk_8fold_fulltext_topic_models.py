...
datadir='/scratch/01329/poldrack/textmining/paper/fulltext_8fold/'
outputdir='/scratch/01329/poldrack/textmining/paper/topic_modeling/fulltext/8fold/'

ntopics=N.arange(100,600,20)

for t in ntopics:
  for fold in range(1,9):
    outfile=open('nfold_scripts/run_mallet_fulltext_fold%d_%d.sh'%(fold,t),'w')
    a=50.0/t
