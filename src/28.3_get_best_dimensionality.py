...
for datatype in datatypes:
  ...
  #outputdir='/scratch/01329/poldrack/textmining/paper/topic_modeling/%s/8fold_noopt_%sbeta/'%(datatype,beta)
  outputdir='/scratch/01329/poldrack/textmining/paper/topic_modeling/%s/8fold_opt/'%datatype
  ...
  #N.save(datadir+'%s_8fold_%sbeta_likelihood.npy'%(datatype,beta),data)
  N.save(datadir+'%s_8fold_opt_likelihood.npy'%datatype,data)
