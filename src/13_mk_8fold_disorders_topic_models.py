...
datadir='/scratch/01329/poldrack/textmining/paper/disorders_8fold/'
outputdir='/scratch/01329/poldrack/textmining/paper/topic_modeling/disorders/8fold/'

ntopics=N.arange(10,260,10)

for t in ntopics:
  for fold in range(1,11):
    outfile=open('nfold_scripts/run_mallet_disorders_fold%d_%d.sh'%(fold,t),'w')
    a=50.0/t
